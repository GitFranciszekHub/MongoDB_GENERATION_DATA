...
Biblioteki, moduły które zostały użyte w projekcie: pymongo 4.10.1, matplotlib 3.10.0, Flask 3.0.3, i kilka innych.<br>Aplikacja webowa jest także połączona z wieloma plikami HTML, CSS, czy JS.  

...
Biblioteki, moduły które zostały użyte w projekcie:<br>-pymongo 4.10.1<br>-matplotlib 3.10.0<br>-Flask 3.0.3<br><br>Aplikacja webowa jest także połączona z wieloma plikami HTML, CSS, czy JS.  
